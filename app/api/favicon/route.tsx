...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://blog.mrxir.cloud/favicons/zolplay.png',
  '(?:github.com)': 'https://blog.mrxir.cloud/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://blog.mrxir.cloud/favicons/twitter.png',
  'coolshell.cn': 'https://blog.mrxir.cloud/favicons/coolshell.png',
  'vercel.com': 'https://blog.mrxir.cloud/favicons/vercel.png',
  'nextjs.org': 'https://blog.mrxir.cloud/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://blog.mrxir.cloud/favicon_blank.png'
