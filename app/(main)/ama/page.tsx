...
const description =
  'mrxirzzz 提供一对一的咨询服务（Ask Me Anything）。我有前端开发、全栈开发、UI/UX 设计、创业经验、英语技能、美国留学与工作、内容创作等经验，可以为你解答相关的问题，我也支持纯英语沟通。'
    ...
    <Container className="mt-16 sm:mt-24">
      ...
      <article className="prose dark:prose-invert">
        ...
        <ul>
          ...
          <li>
            <b>英语技能</b>：英语能力不足，想提高自己的英语水平？想跟 mrxirzzz
            一样可以{' '}
            <RichLink
        ...
        <p>
          一旦你完成支付，通过{' '}
          <RichLink
            href="https://blog.mrxir.cloud/ask-me-anything"
            target="_blank"
          >
            这个链接
          </RichLink>
